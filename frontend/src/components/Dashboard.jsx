            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mb-2">
                  This is an Explainable RAG system that uses knowledge graphs
                  to provide transparent, traceable answers grounded in your
                  uploaded documents.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>
                    • Upload PDFs or text files to build a searchable knowledge
                    base
                  </li>
                  <li>
                    • Ask natural language questions and receive grounded
                    answers
                  </li>
                  <li>
                    • View extracted entities and relationships in an
                    interactive graph
                  </li>
